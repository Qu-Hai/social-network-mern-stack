...
class EditProfile extends Component {
  ...
  submitHandler = (e) => {
    ...
    dataForm.append('avatar', this.state.image);
    dataForm.append('id', this.props.profile._id);
    dataForm.append('location', this.state.location);
    this.props.updateUser(dataForm);
  };
  render() {
